  ...
  return (
    <>
      <style>{`
        ...
        .nav-desktop-right { display: flex; align-items: center; justify-content: flex-end; gap: 1.5rem; }
      ...
      >
        <div className="nav-bar">
          {/* Left: logo (after scroll, desktop only) */}
          ...
          {open && (
            ...
            >
              <div style={{ padding: '1rem 1.25rem 2rem' }}>
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.25 }} style={{ marginTop: '1rem' }}>
                  <a href="tel:+48733355075" style={{
                    display: 'block', textAlign: 'center', padding: '0.75rem',
                    color: 'rgba(237,232,223,0.6)', fontSize: '14px', textDecoration: 'none',
                    borderBottom: '1px solid rgba(237,232,223,0.06)',
                  }}>
                    733 355 075
                  </a>
                </motion.div>
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} style={{ marginTop: '1rem' }}>
                  <a href="https://zamow.online" target="_blank" rel="noopener noreferrer" style={{
